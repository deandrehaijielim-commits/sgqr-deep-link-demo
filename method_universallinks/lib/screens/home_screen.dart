      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              "An Associated Domains entitlement plus a hosted apple-app-site-association are meant to prove this app owns the domain — a silent handoff with no Safari, no prompt.",
              style: const TextStyle(color: Colors.black54, fontSize: 13),
            ),
            const SizedBox(height: 12),
            Text(
              "Real verification requires a paid Apple Developer Program membership. Tested on a free account: the entitlement was present in the signed binary, but iOS never completed verification — every link fell through to Safari with a manual banner instead of a silent handoff.",
