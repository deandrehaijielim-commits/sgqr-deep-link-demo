...
android {
    namespace = "com.sgqrdemo.bankcapp"
    ...
    defaultConfig {
        applicationId = "com.sgqrdemo.bankcapp"
        minSdk = flutter.minSdkVersion
        targetSdk = flutter.targetSdkVersion
        versionCode = flutter.versionCode
        versionName = flutter.versionName
        resValue("string", "app_name", "Bank C")
        // This app's custom URL scheme, e.g. bankcdemo://pay?token=xyz
        manifestPlaceholders["urlScheme"] = "bankcdemo"
