      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              "The link names this app's package directly (package=com.sgqrdemo.method_explicit_intent) — Android has nothing left to disambiguate, so it skips the chooser unconditionally.",
              style: const TextStyle(color: Colors.black54, fontSize: 13),
            ),
            const SizedBox(height: 12),
            Text(
              "Only works when the link's generator already knows which app should open it — the opposite of the \"any of 3 banks\" scenario the rest of this project demonstrates.",
              style: const TextStyle(color: Colors.deepOrange, fontSize: 12, fontStyle: FontStyle.italic),
            ),
            const SizedBox(height: 12),
            Text(
              "Tested live on a real Android device: opened directly, zero prompt.",
