...
/// Thrown when another app already paid this token first.
...
class PaymentApi {
  ...
  static Future<PaymentPayload> confirmPayment(String token, String methodId) async {
    final uri = Uri.parse('$kBackendBaseUrl/api/payload/$token/pay');
    final res = await http.post(
      uri,
      headers: {'Content-Type': 'application/json'},
      body: jsonEncode({'bank': methodId}),
    );
