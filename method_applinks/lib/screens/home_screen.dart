      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              "autoVerify=\"true\" plus a hosted assetlinks.json prove this app owns the domain, so a tap opens it directly — no chooser, no browser interstitial — even with other apps installed.",
              style: const TextStyle(color: Colors.black54, fontSize: 13),
            ),
            const SizedBox(height: 12),
            Text(
              "Tested live on a real Android device: opened directly, zero prompt, correct payload fetched.",
